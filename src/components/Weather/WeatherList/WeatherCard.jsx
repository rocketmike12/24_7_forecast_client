...
export const WeatherCard = function ({ openForecast, closeForecast, place }) {
		...
		<>
			<li>
				<div className={styles["weather__card__location"]}>
					...
					<p className={styles["weather__card__location__country"]}></p>
				</div>
				...
				<div className={styles["weather__card__date"]}>
					<p className={styles["weather__card__date__date"]}>{`${date.toLocaleDateString("en-GB", { day: "numeric" })}.${date.toLocaleDateString("en-GB", { month: "numeric" })}.${date.toLocaleDateString("en-GB", { year: "numeric" })} `}</p>
				...
				<div className={styles["weather__card__button-wrap"]}>
					...
					<button className={styles["weather__card__delete-button"]}>
						<FaRegTrashCan />
					</button>
				</div>
			</li>
